...
function WordCloud({
  ...
  const getAllObjectValWordCounts = (dict) => {
    ...
    for (let key of keys) {
      ...
      if (typeof val === "object") {
        ...
        const recursedVals = getAllObjectValWordCounts(val);
        ...
        const strCounts = getAllStringWordCounts(strData);
  ...
  switch (typeof data) {
    case "object":
      wordCounts = getAllObjectValWordCounts(data);
      break;
    case "string":
      wordCounts = getAllStringWordCounts(data);
      break;
    default:
      break;
  }

...
export function Pose({
  ...
  // overwrite default joints with zuck joints
  //   if (USE_DEFAULT_ZUCK_POSE) {
  //     basePose.joints = {
  //       head: [-0.015151105608258929, 0.4749763488769531],
  //       l_shoulder: [0.22852434430803573, 1.474997329711914],
  //       l_elbow: [0.3864998953683036, 2.617654037475586],
  //       l_wrist: [1.03096923828125, 3.203685760498047],
  //       r_shoulder: [-0.8992165701729911, 1.4161243438720703],
  //       r_elbow: [-0.6856236049107143, 2.711177444458008],
  //       r_wrist: [0.34967171805245534, 3.6373317718505858],
  //       l_hip: [0.15915440150669644, 3.3800888061523438],
  //       l_knee: [-0.33939078194754463, 4.758314514160157],
  //       l_ankle: [-0.6899422781808036, 6.708499145507813],
  //       l_toetip: [0.3141204833984375, 6.7678367614746096],
  //       r_hip: [-0.8371791294642857, 3.3420761108398436],
  //       r_knee: [-0.05901445661272321, 4.823992919921875],
  //       r_ankle: [-0.38572256905691965, 6.677095794677735],
  //       r_toetip: [0.4934029715401786, 6.592479705810547],
  //     };
  //   }

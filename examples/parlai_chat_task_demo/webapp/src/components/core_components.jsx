...
class MessageList extends React.Component {
  makeMessages() {
    ...
    if (typeof onClickMessage !== 'function') {
      onClickMessage = idx => {alert("You've clicked on message number: " + idx)};
    }
    ...
    return (
      <div>
        ...
        <p>
          ...
          components as well, as in this example we've made it so that if 
          you click a message, it will alert with that message idx.
        </p>
        <p>
          The current contents of task data are as follows: {JSON.stringify(this.props.task_data)}
        </p>
        <p>

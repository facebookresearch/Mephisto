...
function WorkerOpinion(props: WorkerOpinionPropsType) {
  ...
  return (
    ...
    >
      ...
      <div className={"questions"}>
        {data.questions.map((question: WorkerOpinionQuestionType, index: number) => {
          return (
            <div className={"question"} key={`worker-opinion-question-${index}`}>
              <div className={"question-title"}>
                {question.question}
              </div>
              <pre className={"question-answer"}>
                {question.answer}
              </pre>
            </div>
          );
      ...
      <div className={"attachments"}>
        ...
        {data.attachments.map((attachement: WorkerOpinionAttachmentType, index: number) => {
          return (
            <div

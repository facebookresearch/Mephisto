...
function ReviewModal(props: ReviewModalProps) {
  ...
  return props.show && <Modal className={"review-modal"} show={props.show} onHide={onModalClose}>
    <Modal.Header closeButton={false}>
      <Modal.Title>{props.data.title}</Modal.Title>
    </Modal.Header>

    <Modal.Body>
      <ModalForm data={props.data} setData={props.setData} />
    </Modal.Body>

    <Modal.Footer>
      <div className={"review-buttons"}>
        <Button variant={"cancel-button link"} size={"sm"} onClick={onModalClose}>

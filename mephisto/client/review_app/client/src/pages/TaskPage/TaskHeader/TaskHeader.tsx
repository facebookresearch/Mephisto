        ...
        <Col sm={6}>
          <Table className={'table'} responsive={"sm"} bordered={false}>
            <thead>
              <tr>
                <th></th>
                <th className={"title center text-secondary"}><b>Reviewed</b></th>
                <th className={"title center text-success"}><b>Approved</b></th>
                <th className={"title center text-warning"}><b>Soft&#8209;Rejected</b></th>
                <th className={"title center text-danger"}><b>Rejected</b></th>
              </tr>
            </thead>
            <tbody>
              {/* Worker line */}

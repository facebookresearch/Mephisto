# Mephisto
This is the main package directory, containing all of the core workings of Mephisto. They roughly follow the divisions noted in the [architecture overvierw doc](https://github.com/facebookresearch/Mephisto/blob/master/docs/architecture_overview.md#agent). The breakdown is as following:

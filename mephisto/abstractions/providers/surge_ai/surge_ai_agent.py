...
class SurgeAIAgent(Agent):
    ...
    def observe(self, live_update: Dict[str, Any]) -> None:
        """Put observations into this Surge AI agent's observation list"""
    ...
    def mark_disconnected(self) -> None:
        """Mark this Surge AI agent as having disconnected"""
    ...
    def new(db: "MephistoDB", worker: "Worker", unit: "Unit") -> "Agent":
        ...
        return SurgeAIAgent._register_agent(db, worker, unit, PROVIDER_TYPE)

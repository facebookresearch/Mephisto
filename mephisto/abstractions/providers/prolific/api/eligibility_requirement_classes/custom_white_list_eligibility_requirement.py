...
CUSTOM_WHITE_ELIGIBILITY_REQUIREMENT = 'CustomWhitelistEligibilityRequirement'
...
class CustomWhitelistEligibilityRequirement(BaseEligibilityRequirement):
    ...
    """
    prolific_cls_name = f'web.eligibility.models.{CUSTOM_WHITE_ELIGIBILITY_REQUIREMENT}'

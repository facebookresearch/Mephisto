...
class Task:
    ...
    @staticmethod
    def new(task_name: str, db: MephistoDB, task_type: str, project: Optional[Project] = None)
        '''
...
class TaskRun:
    ...
    def get_assignments(self, status: Optional[str] = None) -> List[Assignments]:
        ...
        current status
        '''
        assert status is None or status in ASSIGNMENT_STATUSES, 'Invalid assignment status'

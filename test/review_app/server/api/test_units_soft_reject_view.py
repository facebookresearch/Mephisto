...
class TestUnitsSoftRejectView(BaseTestApiViewCase):
    ...
    def test_units_soft_reject_success(self, *args, **kwargs):
        # Task Run
        ...
        self.assertEqual(unit.get_db_status(), AssignmentState.SOFT_REJECTED)
